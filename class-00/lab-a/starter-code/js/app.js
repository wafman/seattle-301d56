...
function displayPics(){
  ...
  // the const variable declaration is contained to the scope where it is initialized. It was initialized in this place, inside of the function, then there was an attempt to console log that variable outside the scope where it was declared. 
  console.log(viewed);
